...
def test_randomized_response(rng_factory, bitarray_factory):
    harden_rand_resp = harden.randomized_response(rng_factory, 0.5)
...
def test_randomized_response_same_seed(rng_factory, bitarray_factory):
    harden_rand_resp_1 = harden.randomized_response(rng_factory, 0.5)
    harden_rand_resp_2 = harden.randomized_response(rng_factory, 0.5)
...
def test_randomized_response_same_seed_different_probability(rng_factory, bitarray_factory):
    harden_rand_resp_1 = harden.randomized_response(rng_factory, 0.5)
    harden_rand_resp_2 = harden.randomized_response(rng_factory, 0.25)
